...
function(build_external_cmake_project)
  ...
  file(GLOB_RECURSE _CONFIG_DEPS FOLLOW_SYMLINKS LIST_DIRECTORIES true "${_RULE_SRC_DIR}/*")
  list(APPEND _CONFOG_DEPS "${_RULE_SRC_DIR}")
  set_property(DIRECTORY APPEND PROPERTY CMAKE_CONFIGURE_DEPENDS ${_CONFIG_DEPS})
endfunction()
